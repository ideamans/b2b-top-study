---
title: 課題解決
description: '「こんなお悩みありませんか？」という課題提起から、サービスによる解決策を提示するセクションです。訪問者が抱える具体的な課題を列挙したうえで「このサービスなら解決できます」と結びつけることで、サービスの必要性を実感させます。'
---
...
![分布](/screenshots/histograms/problem-solution.png)
